...
class CustomPaginatedDataTable extends StatelessWidget {
  const CustomPaginatedDataTable({
    ...
    this.dataRowHeight = DimenSizes.xl * 2,
      ...
      child: Theme(
        ...
        child: PaginatedDataTable2(
          ...
          headingRowColor: WidgetStateProperty.resolveWith(
              (states) => CustomColors.primaryBackground),
          empty: CustomAnimationLoaderWidget(
          ...
          sortArrowBuilder: (bool ascending, bool sorted) {
            if (sorted) {
              return Icon(ascending ? Iconsax.arrow_up_3 : Iconsax.arrow_down,
                  size: DimenSizes.iconSm);
            } else {
              return const Icon(Iconsax.arrow_3, size: DimenSizes.iconSm);
            }
          },
        ),
      ),
